...
<?php require 'head.php'; ?><style>
    body{
        background: url(image/image.png) repeat center;
    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">Select Blood Group:</label>
               ...
               <a href="deleteit.php" class="btn btn-info btn1 mr-4"> Reset</a>
               <input type="submit" name="submit" class="btn btn-info btn1" value="search">
           </form>
        </div>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><input type="submit" name="request" class="btn btn-info btn1" value="Request Sample"></td>
                <?php } ?>
