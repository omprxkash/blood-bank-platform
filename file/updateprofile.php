...
if(isset($_POST['update'])){
    ...
    $update = "UPDATE receivers SET rname='$rname', remail='$remail', rpassword='$rpassword', rphone='$rphone', rbg='$bg',raddress='$raddress',rdonationhistory='$rdonationhistory',rhealthhistory='$rhealthhistory' WHERE id='$id'";
