    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" name="raddress" placeholder="User Address" class="form-control mb-3" required>
          ...
          <input type="text" name="rdoantionhistory" placeholder="User Donation History" class="form-control mb-3" required>
          <input type="text" name="rhealthhistory" placeholder="User Health History" class="form-control mb-3" required>
