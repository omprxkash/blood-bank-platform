				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Address</label>
						<input type="text" name="raddress" value="<?php echo $row['raddress']; ?>" class="form-control mb-3">
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Health History</label>
						<input type="text" name="raddress" value="<?php echo $row['rdonationhistory']; ?>" class="form-control mb-3">
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Donation History</label>
						<input type="text" name="raddress" value="<?php echo $row['rhealthhistory']; ?>" class="form-control mb-3">
