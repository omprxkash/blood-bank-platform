...
<!DOCTYPE html>
<html>
<?php $title="VITAL VESSEL | home page"; ?>
...
<body style="background-color:bisque;color:black">
  ...
  <a class="navbar-brand" href="#">VITAL VESSEL</a>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/VITAL VESSELS.jpg" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="image/home2.jpg" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="image/home3.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
...
<section class="my-5">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-12">
      <h2>VITAL VESSELS - "We here to save you!"</h2>
...
<section class="my-5">
  ...
  <div>
  <p class="text-center text-white" style="background-color:black;margin: auto; width: 50%; padding: 10px;">
    N L PADMA SWATI 22BRS1259 +91 72590 07271 <br>
    S VANSHITA GUPTA 22BRS1251 +91 87783 34586 <br>
</p>
